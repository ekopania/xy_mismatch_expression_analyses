...
for(i in mygroups){
		...
		group_names_all<-c(group_names_all, "CCPPLY_LZ")
	} else if(i==4){
                group_names_all<-c(group_names_all, "CCPPLY_RS")
        } else if(i == 5){
		group_names_all<-c(group_names_all, "LLPP_LZ")
	} else if(i==6){
                group_names_all<-c(group_names_all, "LLPP_RS")
        } else if(i == 7){
		group_names_all<-c(group_names_all, "LLPPLY_LZ")
	} else if(i==8){
                group_names_all<-c(group_names_all, "LLPPLY_RS")
        } else if(i == 9){
		group_names_all<-c(group_names_all, "PPLLPY_LZ")
	} else if(i==10){
                group_names_all<-c(group_names_all, "PPLLPY_RS")
        } else if(i == 11){
		group_names_all<-c(group_names_all, "PPLL_LZ")
	} else if(i==12){
                group_names_all<-c(group_names_all, "PPLL_RS")
        } else if(i == 13){
		group_names_all<-c(group_names_all, "WWLLPY_LZ")
	} else if(i==14){
                group_names_all<-c(group_names_all, "WWLLPY_RS")
        } else if(i == 15){
