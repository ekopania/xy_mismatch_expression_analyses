#!/bin/bash
#PURPOSE: run 11_edgeR_DE.r to test for DE between XY mismatch and match cross types
#
# Job name:
#SBATCH --job-name=EdgeR_DE
#SBATCH --output=edgeR_DE-%j.log
